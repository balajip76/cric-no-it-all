  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-16">
      <div className="text-center mb-10">
        <h1 className="text-5xl font-extrabold text-lavender-dark mb-3">
          Cric No-It-All
        </h1>
        <p className="text-lg text-lavender-mid max-w-md mx-auto">
      ...
      <SearchBar />
      <p className="mt-6 text-sm text-lavender-muted">
